...
export default function TaskDetailScreen() {
  ...
  const { tasks, deleteTask, loading } = useTaskContext();
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      // TODO: Implement updateTask in context instead of delete/add
  ...
  }, [currentTask, title, description, deleteTask, router]);
